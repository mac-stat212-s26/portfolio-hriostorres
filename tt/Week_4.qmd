---
title: "W4: Brazilian Enterprises"
...
companies |>
  mutate(
    capital_stock_m = capital_stock / 1000000,
    company_size = recode(
      company_size,
  ...
  ggplot(aes(x = legal_nature, y = capital_stock_m)) +
  geom_boxplot()+
  ...
  subtitle = "Note that we limited the study to enterprises with capital stock below 1 million BRL,\nand we ignore a third category called 'other'.",
    x = "Legal Nature",
    y = "Capital Stock (Million BRL)",
    caption = "Source: TidyTuesday Challenge Week 4, 2026. Author: David Rios") +
