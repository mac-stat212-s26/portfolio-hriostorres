...
```{r reading}
#| eval: false
data_by_dist <- read_rds("/Users/davidrios/portfolio-hriostorres/ica/17_Interactive_Viz/diverse_data_by_dist.rds")
data_by_year <- read_csv("/Users/davidrios/portfolio-hriostorres/ica/17_Interactive_Viz/diverse_data_by_year.csv")

metro_names <- data_by_dist |> 
  pull(metro_name) |> unique()
```
